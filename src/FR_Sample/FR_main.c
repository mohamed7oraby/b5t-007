...
int main(int argc, char *argv[])
{
    ...
    if (gpioInitialise() < 0) 
    {
        PrintLog("Couldn't initialize gpio\n");
        return -1;
    }
    ...
    do {
        ...
        */
        ...
        do {
            ...
            if (stb_use == STB_ON) {
            //MO    execFlag = HVC_ACTIV_FACE_DETECTION | HVC_ACTIV_FACE_DIRECTION | HVC_ACTIV_FACE_RECOGNITION;
            } else {
