...
int main(int argc, char *argv[])
{
    ...
    do {
        ...
        //This works, you need to delete before loading the album + before running delete the registered images and album
        /*********************************/
        /* Delete User              MO*/ 
        /*********************************/
        //ret = HVC_DeleteAll(860000,  &status);
        //printf("Delete all return value %d",ret);
